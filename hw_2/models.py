...
class Client(models.Model):
    ...
    def __str__(self):
        return f'Имя клиента: {self.name}, email: {self.email}, номер телефона: {self.phone_number}, адрес: {self.address}, дата регистрации: {self.registration_date}'
